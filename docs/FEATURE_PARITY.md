...
| DOC-004 | Save to file | n/a (.NET bridge is bytes-only by design) |
...
| Feature ID | Feature Name | .NET |
|---|---|---|
| OPS-001 | Split to pages | yes (bytes-in/bytes-out) |
| OPS-002 | Merge from files | yes (bytes-in/bytes-out) |
| OPS-003 | Rotate all pages | yes (bytes-in/bytes-out) |
| OPS-004 | Extract pages | yes (bytes-in/bytes-out) |
